...
public class ViewAllSprays extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category_name.setText("DISINFECTANT SPRAYS");
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ViewAllSprays.this, MainActivity.class);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.secondFragment:
                        Intent intent2 = new Intent(ViewAllSprays.this, SearchActivity.class);
