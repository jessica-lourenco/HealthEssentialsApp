...
public class ViewAllHandSanitizers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category_name.setText("HAND SANITIZERS");
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ViewAllHandSanitizers.this, MainActivity.class);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.secondFragment:
                        Intent intent2 = new Intent(ViewAllHandSanitizers.this, SearchActivity.class);
